...
This project satisfies the activity objective because it calculates descriptive statistics and builds representative indicators from a clean dataset generated by the system.

The system produces a structured dataset from live webcam detections and transforms it into meaningful indicators for analysis. These indicators help answer a real business-style question:

> How can live gesture data be transformed into descriptive indicators to monitor user behavior, gesture frequency, hand usage, and identity patterns in real time?

The bonus feature is also included through automatic gesture-sequence identity recognition.
